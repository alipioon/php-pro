        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <?php if($submenu[$f]->menu_id == $vl and $submenu[$f]->class != $sub){ ?>
                    <li><a href=<?php echo $submenu[$f]->class ?>
                            id="<?php echo $submenu[$f]->id; ?>">
                            <?php echo ucfirst($submenu[$f]->class); ?> </a></li>
                    <?php $sub = $submenu[$f]->class ?>
